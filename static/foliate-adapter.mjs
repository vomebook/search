...
export async function openFoliate(bytes, name, type = "application/octet-stream", onView) {
  ...
  view.setReaderTheme = (theme) => view.renderer.setStyles(theme === "light" ? ":root, body { background: #ffffff !important; color: #202124 !important; } a, a * { color: #165ea8 !important; } img, svg, video { max-width: 100%; }" : ":root, body { background: #181b1e !important; color: #e7e9eb !important; } a, a * { color: #8ab4e8 !important; } img, svg, video { max-width: 100%; }");
